...
import ru.yandex.practicum.controller.clients.CategoryClient;
import ru.yandex.practicum.controller.clients.CommentClient;
...
public class EventServiceImpl implements EventService {
    ...
    private final CommentClient commentRepository;
    ...
    public List<EventShortDto> getAllEvents(ReqParam reqParam) {
        ...
        List<EventCommentCount> eventCommentCountList = commentRepository.getCountByEventIds(eventsIds);
    ...
    public EventFullDto publicGetEvent(long id) {
        ...
        eventFullDto.setCommentsCount(commentRepository.getCountByEventId(event.getId()));
    ...
    public EventFullDto create(Long userId, NewEventDto newEventDto) {
        ...
        Category category = categoryRepository.getFullCategoriesById(newEventDto.getCategory())
    ...
    public List<Event> getAllEventByInitiatorId(Long initiatorId) {
        User initiator = userRepository.getUserById(initiatorId)
                .orElseThrow(() -> new EntityNotFoundException(User.class, "Пользователь не найден"));
        return eventRepository.findAllByInitiatorId(initiatorId);
    }
    ...
    private void checkEvent(Event event, UpdateEventBaseRequest updateRequest) {
        ...
        if (updateRequest.getCategory() != null) {
            Category category = categoryRepository.getFullCategoriesById(updateRequest.getCategory())
