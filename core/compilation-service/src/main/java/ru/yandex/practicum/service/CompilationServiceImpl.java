...
public class CompilationServiceImpl implements CompilationService {
    ...
    public CompilationDto create(NewCompilationDto newCompilationDto) {
        ...
        if (newCompilationDto.getEvents() != null) {
            List<Event> events = eventRepository.getAllEventsByIdIsIn(newCompilationDto.getEvents());
    ...
    public CompilationDto update(Long id, UpdateCompilationRequest updateCompilationRequest) {
        ...
        if (updateCompilationRequest.getEvents() != null) {
            List<Event> events = eventRepository.getAllEventsByIdIsIn(updateCompilationRequest.getEvents());
